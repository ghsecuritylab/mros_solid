...
std::string getbool(std::string param){
    std::string val;
...
std::string getint(std::string param){
    std::string val;
    if(param.find("<int>") != -1){
...
std::string getdouble(std::string param){
    std::string val;
...
std::string getstd::string(std::string param){
    std::string val;
...
std::string getarray(std::string param){
    std::string val;
...
std::string getdate(std::string param){
    std::string val;
...
std::string getbinary(std::string param){
    std::string val;
...
std::string getstruct(std::string param){
    std::string val;
...
std::string gettagless(std::string param){
    std::string val;
...
void valparse(xmlNode *node,std::string param){
...
void paramparser(xmlNode *node,std::string params){
    std::string param;
    int phead,ptail;
...
void faultparser(xmlNode *node,std::string body){
    node->params.push_back(getint(body));
    node->params.push_back(getstd::string(body));
}

void callparser(xmlNode *node,std::string xml){
    std::string  m_call;
    std::string  m_name;
    std::string  params;
...
void resparser(xmlNode *node,std::string xml){
    std::string resp;
    std::string body;
    std::string params;
    //Response
...
bool parser(xmlNode *node,std::string xml){
...
int ParseReceiveMessage(std::string http,xmlNode *node){
...
std::string get_ip(std::string xml)
{
	int head, tail;
	std::string body;
	head = (int)xml.find("<std::string>http://");
	tail = (int)xml.find(":", head + sizeof("<std::string>http://"));
	for (int i = head + sizeof("<std::string>http://") - 1; i < tail; i++)
	{
		body = body + xml[i];
	}
	return body;

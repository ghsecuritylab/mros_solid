...
#define LIN0_PA    (0xFCFE9000uL) /* LIN0 */
#define LIN1_PA    (0xFCFE9800uL) /* LIN1 */
#define LIN0    (*(struct st_lin     *)g_LIN0Regs.addr) /* LIN0 */
#define LIN1    (*(struct st_lin     *)g_LIN1Regs.addr) /* LIN1 */

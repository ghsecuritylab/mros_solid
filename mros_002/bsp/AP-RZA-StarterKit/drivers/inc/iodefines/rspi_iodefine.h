...
#define RSPI0_PA   (0xE800C800uL) /* RSPI0 */
#define RSPI1_PA   (0xE800D000uL) /* RSPI1 */
#define RSPI2_PA   (0xE800D800uL) /* RSPI2 */
#define RSPI3_PA   (0xE800E000uL) /* RSPI3 */
#define RSPI4_PA   (0xE800E800uL) /* RSPI4 */
#define RSPI0   (*(struct st_rspi    *)g_RSPI0Regs.addr) /* RSPI0 */
#define RSPI1   (*(struct st_rspi    *)g_RSPI1Regs.addr) /* RSPI1 */
#define RSPI2   (*(struct st_rspi    *)g_RSPI2Regs.addr) /* RSPI2 */
#define RSPI3   (*(struct st_rspi    *)g_RSPI3Regs.addr) /* RSPI3 */
#define RSPI4   (*(struct st_rspi    *)g_RSPI4Regs.addr) /* RSPI4 */

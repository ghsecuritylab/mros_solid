...
#define SPIBSC0_PA (0x3FEFA000uL) /* SPIBSC0 */
#define SPIBSC1_PA (0x3FEFB000uL) /* SPIBSC1 */
#define SPIBSC0 (*(struct st_spibsc  *)g_SPIBSC0Regs.addr) /* SPIBSC0 */
#define SPIBSC1 (*(struct st_spibsc  *)g_SPIBSC1Regs.addr) /* SPIBSC1 */

...
/***********************************************************************
* File: locking.h
*    Lock related FIT BSP. Functions.
*
...
/***********************************************************************
* Function: R_BSP_HardwareLock
*    Attempts to reserve a hardware peripheral lock.
*
* Arguments:
*    HardwareIndex - Index of lock to acquire from the hardware lock array.
*
* Return Value:
...
/***********************************************************************
* Function: R_BSP_HardwareUnlock
*    Releases a hardware peripheral lock.
*
* Arguments:
*    HardwareIndex - Index of lock to release from the hardware lock array.
*
* Return Value:
*    true = Successful, false = Failure
************************************************************************/
...
/***********************************************************************
* Function: R_BSP_SoftwareLock
*    Attempts to reserve a lock.
*
* Arguments:
*    LockObject - Pointer to lock structure with lock to try and acquire.
*
* Return Value:
*    true = Successful, false = Failure
************************************************************************/
...
/***********************************************************************
* Function: R_BSP_SoftwareUnlock
*    Releases a lock.
*
* Arguments:
*    LockObject - Pointer to lock structure with lock to release.
*
* Return Value:
*    true = Successful, false = Failure
************************************************************************/

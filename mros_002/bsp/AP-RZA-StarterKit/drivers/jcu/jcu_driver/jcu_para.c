    ...
    const jcu_codec_t   codec)
{
    ...
    R_UNREFERENCED_VARIABLE( codec );  /* for Release configuration */
    ...
    const jcu_table_no_t   tableNo)
{
    ...
    R_UNREFERENCED_VARIABLE( tableNo );  /* for Release configuration */
    ...
    const jcu_huff_t       type)
{
    ...
    R_UNREFERENCED_VARIABLE( type );  /* for Release configuration */

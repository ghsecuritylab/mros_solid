...
/***********************************************************************
* Function: R_DRV_SET_REGISTER_BIT_FIELD
*    Set a value to register bit field.
*
* Arguments:
*    in_out_Register - Address of register or variable
...
/***********************************************************************
* Function: R_DRV_SET_REGISTER_BIT_FIELD_WITH_REG_WIDTH
*    Set a value to register bit field with width parameter.
*
* Arguments:
*    in_out_Register - Address of register or variable
*    RegisterName    - Name of register
...
/***********************************************************************
* Function: R_DRV_GET_REGISTER_BIT_FIELD
*    Get a value from register bit field.
*
* Arguments:
*    RegisterValue - Value of register or variable
*    RegisterName  - Name of register
*    BitName       - Name of bit
*
* Return Value:
*    Value of shifted bit field.
*
* Description:
*    Bit width is got from "RegisterName".
************************************************************************/
...
/***********************************************************************
* Function: R_DRV_GET_REGISTER_BIT_FIELD_WITH_REG_WIDTH
*    Get a value from register bit field with width parameter.
*
* Arguments:
*    RegisterValue - Value of register or variable
*    RegisterName  - Name of register
...
/***********************************************************************
* Function: R_DRV_IS_OVERFLOW_BIT_FIELD
*    Returns whether specified value is overflowed from the bit field.
*
* Arguments:
*    RegisterName  - Name of register
*    BitName       - Name of bit
...
*
* Return Value:
*    Whether specified value is overflowed.
************************************************************************/
/* ->MISRA 19.12 */ /* ->MISRA 19.13 */ /* ->SEC M5.1.2 (1) */
...
/***********************************************************************
* Function: R_DRV_IS_OVERFLOW_BIT_FIELD_WITH_REG_WIDTH
*    Returns whether specified value is overflowed from the bit field.
*
* Arguments:
*    RegisterName  - Name of register

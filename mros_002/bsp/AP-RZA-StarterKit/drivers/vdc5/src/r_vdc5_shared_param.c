...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmInit()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmInit()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetInitParam()_E");
    shared_param_common = &param_common[ch];
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetTerminate()_E");
    shared_param_common = &param_common[ch];

    /* Reference to the LVDS PLL clock */
    shared_param_common->lvds_ref = VDC5_OFF;
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetTerminate()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetInputParam()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetInputParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetSyncParam()_E");
    shared_param_common = &param_common[ch];

    shared_param_common->res_vs_in_sel = param->res_vs_in_sel;
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetSyncParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetOutputParam()_E");
    shared_param_common = &param_common[ch];
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetOutputParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetWriteParam()_E");
    shared_param_scaling = &param_scaling[ch][scaling_id];
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetWriteParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetChgWriteParam()_E");
    shared_param_scaling = &param_scaling[ch][scaling_id];
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetChgWriteParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetReadParam()_E");
    shared_param_graphics = &param_graphics[ch][graphics_id];
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetReadParam()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetChgReadParam()_E");
    shared_param_graphics = &param_graphics[ch][graphics_id];
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetCascade()_E");
    param_common[ch].cascade = cascade;
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetCascade()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetUndSel()_E");
    param_common[ch].und_sel = und_sel;
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetUndSel()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetPanelClkSel()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetPanelClkSel()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLvdsClkRef()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLvdsClkRef()_X");
    return onoff;
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpace()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpace()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetInputSelect()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetInputSelect()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetVsInSel()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetVsInSel()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetCascade()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetCascade()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetUndSel()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetUndSel()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetBgColor()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetBgColor()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetWritingMode()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetWritingMode()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetInterlace()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetInterlace()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpaceFbWr()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpaceFbWr()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetFrBuffBtm()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetFrBuffBtm()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLineOfsAddrDir()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLineOfsAddrDir()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetSelFbAddrSig()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetSelFbAddrSig()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetGraphicsFormat()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetGraphicsFormat()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpaceFbRd()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetColorSpaceFbRd()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetMeasureFolding()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetMeasureFolding()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetDisplayArea()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetDisplayArea()_X");
...
vdc5_width_read_fb_t * VDC5_ShrdPrmGetFrBuffWidth_Rd (
    ...
    const vdc5_graphics_type_t  graphics_id)
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetFrBuffWidth_Rd()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetFrBuffWidth_Rd()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLvdsCh()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLvdsCh()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetResource()_E");
    resource_state = GetResourceStatePointer(ch, rsrc_type);
    if (resource_state != NULL)
    {
        *resource_state = rsrc_state;
    }
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetResource()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetLayerResource()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetLayerResource()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetResource()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetResource()_X");
    return rsrc_state;
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLayerResource()_E");
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetLayerResource()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetRwProcEnable()_E");
    if (layer_id != VDC5_LAYER_ID_ALL)
    {
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetRwProcEnable()_X");
...
{
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetRwProcDisable()_E");
    if (layer_id != VDC5_LAYER_ID_ALL)
    {
        if (layer_resource[ch][layer_id] != VDC5_RESOURCE_ST_INVALID)
        {
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmSetRwProcDisable()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetRwProcReady()_E");
    if ((layer_resource[ch][layer_id] != VDC5_RESOURCE_ST_INVALID) &&
        (rw_proc_state[ch][layer_id] == VDC5_RW_PROC_STATE_DISABLE))
    {
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetRwProcReady()_X");
    return state;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetRwProcEnabled()_E");
    if ((layer_resource[ch][layer_id] != VDC5_RESOURCE_ST_INVALID) &&
        (rw_proc_state[ch][layer_id] != VDC5_RW_PROC_STATE_DISABLE))
    {
        state = VDC5_RESOURCE_ST_VALID;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetRwProcEnabled()_X");
    return state;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetOirRwProcEnabled()_E");
    state = VDC5_RESOURCE_ST_INVALID;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_ShrdPrmGetOirRwProcEnabled()_X");
    return state;
...
TOPPERS_SYSLOG(LOG_INFO,"GetResourceStatePointer()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"GetResourceStatePointer()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"SumProduct()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"SumProduct()_X");

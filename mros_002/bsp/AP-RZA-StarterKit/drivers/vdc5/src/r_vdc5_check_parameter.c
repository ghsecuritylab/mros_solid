...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_InitializeCheckPrm()_E");
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_InitializeCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_TerminateCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_TerminateCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_VideoInputCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_VideoInputCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_SyncControlCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_SyncControlCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_DisplayOutputCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_DisplayOutputCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_CallbackISRCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_CallbackISRCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_WriteDataControlCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_WriteDataControlCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChangeWriteProcessCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChangeWriteProcessCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ReadDataControlCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ReadDataControlCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChangeReadProcessCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChangeReadProcessCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_StartProcessCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_StartProcessCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_StopProcessCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_StopProcessCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ReleaseDataControlCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_VideoNoiseReductCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_VideoNoiseReductCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageColorMatrixCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageColorMatrixCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageEnhancementCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageEnhancementCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageBlackStretchCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ImageBlackStretchCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_AlphaBlendingCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_AlphaBlendingRectCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChromakeyCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_ChromakeyCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_CLUTCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_CLUTCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_DisplayCalibrationCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_DisplayCalibrationCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "VDC5_GammaCorrectionCheckPrm()_E");
    error = CheckChannel(ch);
    if (error != VDC5_OK)
    {
        goto END;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "VDC5_GammaCorrectionCheckPrm()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckChannel()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckChannel()_W");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckLayerId()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckLayerId()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckGraphicsTypeLayerId()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckGraphicsTypeLayerId()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckRect()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckRect()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_Horizontal()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_Horizontal()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_HorizontalPol()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_HorizontalPol()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_Vertical()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_Vertical()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_DataEnable()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckTcon_DataEnable()_X");
    return error;
...
TOPPERS_SYSLOG(LOG_INFO, "CheckGammaCrct_GainAdjustment()_E");
    error = VDC5_OK;
...
END:
TOPPERS_SYSLOG(LOG_INFO, "CheckGammaCrct_GainAdjustment()_X");
    return error;

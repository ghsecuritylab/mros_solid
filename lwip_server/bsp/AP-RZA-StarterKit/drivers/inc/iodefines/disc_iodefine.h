...
#define DISC0_PA 0xFCFFA800uL /* DISC0 */
#define DISC1_PA 0xFCFFB000uL /* DISC1 */
#define DISC0   (*(struct st_disc    *)g_DISC0Regs.addr) /* DISC0 */
#define DISC1   (*(struct st_disc    *)g_DISC1Regs.addr) /* DISC1 */

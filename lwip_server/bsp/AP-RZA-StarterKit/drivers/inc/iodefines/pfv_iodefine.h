...
#define PFV0_PA    (0xE8205000uL) /* PFV0 */
#define PFV1_PA    (0xE8205800uL) /* PFV1 */
#define PFV0    (*(struct st_pfv     *)g_PFV0Regs.addr) /* PFV0 */
#define PFV1    (*(struct st_pfv     *)g_PFV1Regs.addr) /* PFV1 */

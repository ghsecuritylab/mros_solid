...
#define RIIC0_PA   0xFCFEE000uL /* RIIC0 */
#define RIIC1_PA   0xFCFEE400uL /* RIIC1 */
#define RIIC2_PA   0xFCFEE800uL /* RIIC2 */
#define RIIC3_PA   0xFCFEEC00uL /* RIIC3 */
#define RIIC0   (*(struct st_riic    *)g_RIIC0Regs.addr) /* RIIC0 */
#define RIIC1   (*(struct st_riic    *)g_RIIC1Regs.addr) /* RIIC1 */
#define RIIC2   (*(struct st_riic    *)g_RIIC2Regs.addr) /* RIIC2 */
#define RIIC3   (*(struct st_riic    *)g_RIIC3Regs.addr) /* RIIC3 */

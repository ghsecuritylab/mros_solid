...
*    Interrupt related FIT BSP. Functions.
*
...
/***********************************************************************
* Function: R_BSP_InterruptWrite
*    Registers a interrupt handler
*
* Arguments:
*    in_IRQ_Num  - Interrupt request number
*    in_Callback - The function as interrupt handler
*
* Return Value:
...
/***********************************************************************
* Function: R_BSP_InterruptRead
*    Returns registered interrupt handler
*
* Arguments:
*    in_IRQ_Num   - Interrupt request number
*    out_Callback - Output: the function as interrupt handler
*
* Return Value:
*    Error code.  If there is no error, the return value is BSP_INT_SUCCESS.
************************************************************************/
...
/***********************************************************************
* Function: R_BSP_InterruptControl
*    Controls related to the interrupt
*
* Arguments:
*    in_IRQ_Num - Interrupt request number
*    in_Command - Control command. See <bsp_int_cmd_t>
*    NotUsed    - Depend on "Command" argument
*
* Return Value:
*    Error code.  If there is no error, the return value is BSP_INT_SUCCESS.
************************************************************************/

...
TOPPERS_SYSLOG(LOG_INFO, "%s:R_VDC5_Initialize()_E",__FILE__);

	/* first of all register address tables need to be initialized */
	initialize_vdc5_regaddr_tables();
...
TOPPERS_SYSLOG(LOG_INFO, "%s: R_VDC5_Initialize()_X",__FILE__);
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_Terminate()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_Terminate()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_VideoInput()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_VideoInput()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_SyncControl()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_SyncControl()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_DisplayOutput()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_DisplayOutput()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_CallbackISR()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_CallbackISR()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_WriteDataControl()_E");
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_WriteDataControl()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ChangeWriteProcess()_E");
    scaling_id = ConvertRwProcId2SclId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ChangeWriteProcess()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ReadDataProcess()_E");
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ReadDataProcess()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ChangeReadProcess()_E");
    graphics_id = ConvertRwProcId2GrId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ChangeReadProcess()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_StartProcess()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_StartProcess()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_StopProcess()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_StopProcess()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ReleaseDataControl()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ReleaseDataControl()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_VideoNoiseReduction()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_VideoNoiseReduction()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageColorMatrix()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageColorMatrix()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageEnhancement()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageEnhancement()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageBlackStretch()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_ImageBlackStretch()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_AlphaBlending()_E");
    graphics_id = ConvertRwProcId2GrId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_AlphaBlending()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_AlphaBlendingRect()_E");
    graphics_id = ConvertRwProcId2GrId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_AlphaBlendingRect()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_Chromakey()_E");
    graphics_id = ConvertRwProcId2GrId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_Chromakey()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_CLUT()_E");
    graphics_id = ConvertRwProcId2GrId(layer_id);
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_DisplayCalibration()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_DisplayCalibration()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_GammaCorrection()_E");
    ret = VDC5_OK;
#ifdef  R_VDC5_CHECK_PARAMETERS
...
TOPPERS_SYSLOG(LOG_INFO, "R_VDC5_GammaCorrection()_X");
    return ret;
...
TOPPERS_SYSLOG(LOG_INFO, "ConvertRwProcId2SclId()_E");
    switch (layer_id)
    {
...
TOPPERS_SYSLOG(LOG_INFO, "ConvertRwProcId2SclId()_X");
    return scaling_id;
...
TOPPERS_SYSLOG(LOG_INFO, "ConvertRwProcId2GrId()_E");
    switch (layer_id)
    {
...
TOPPERS_SYSLOG(LOG_INFO, "ConvertRwProcId2GrId()_X");
    return graphics_id;

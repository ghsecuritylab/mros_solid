...
//#define     LCD_CH0_SIG_FH          (1600u - 1u)                /* Hsync period */
#define     LCD_CH0_SIG_FH          (1056u - 1u)                /* Hsync period */
#else
#define     LCD_CH0_DISP_HS         (225u)                      /* LCD display area size, horizontal start position */ //tokuyama@kmg
#define     LCD_CH0_DISP_HW         (800u)                      /* LCD display area size, horizontal width */
#define     LCD_CH0_DISP_VS         (48u)                       /* LCD display area size, vertical start position */ //tokuyama@kmg
#define     LCD_CH0_DISP_VW         (480u)                      /* LCD display area size, height (vertical width) */
#define     LCD_CH0_SIG_FV          (528u - 1u)                 /* Free-running Vsync period */ //tokuyama@kmg
//#define     LCD_CH0_SIG_FH          (1600u - 1u)                /* Hsync period */ //tokuyama@kmg
#define     LCD_CH0_SIG_FH          (1056u - 1u)                /* Hsync period */ //tokuyama@kmg
#endif

...
TOPPERS_SYSLOG(LOG_INFO,"R_VDC5_GetISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"R_VDC5_GetISR()_X");
     return isr_function;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Int_Disable()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Int_Disable()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Int_SetInterrupt()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Int_SetInterrupt()_X");
}   /* End of function VDC5_Int_Disable() */
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vi_vsync_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vi_vsync_ISR()_X");
...
static void VDC5_Ch0_s0_lo_vsync_ISR (const uint32_t int_sense)
{
    ...
    UNUSED_PARAM(int_sense);
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_lo_vsync_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vsyncerr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vsyncerr_ISR()_X");
 ...
 * @retval      None
 *****************************************************************************/
// VDC5の割り込みはこれを使うみたいなので、外部から呼び出せるように... tokuyama@kmg 2016.09.26
static void VDC5_Ch0_vline_ISR (const uint32_t int_sense)
{
    uint32_t            IntState;
    volatile uint32_t * int_clhd_reg;
...
//TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_vline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int4;
    IntState      = *int_onoff_reg;
TOPPERS_SYSLOG(LOG_INFO,".");
...
//TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_vline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vfield_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_vfield_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv1_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv1_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv3_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv3_vbuferr_ISR()_X");
...
static void VDC5_Ch0_iv5_vbuferr_ISR (const uint32_t int_sense)
{
    ...
    UNUSED_PARAM(int_sense);
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv5_vbuferr_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv5_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv6_vbuferr_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv6_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_wline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s0_wline_ISR()_X");
...
static void VDC5_Ch0_s1_vi_vsync_ISR (const uint32_t int_sense)
{
    ...
    UNUSED_PARAM(int_sense);
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vi_vsync_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vi_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_lo_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vsyncerr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vsyncerr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vfield_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_vfield_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv2_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv2_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv4_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv4_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_wline_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_s1_wline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_vi_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_vi_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_lo_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_vline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_vline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_oir_vfield_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv7_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv7_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv8_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_0].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch0_iv8_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vi_vsync_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vi_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_lo_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vsyncerr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vsyncerr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_vline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_vline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vfield_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_vfield_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv1_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv1_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv3_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv3_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv5_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int1;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int4;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv5_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv6_vbuferr_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv6_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_wline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s0_wline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vi_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vi_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_lo_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vsyncerr_ISR()_E");
    UNUSED_PARAM(int_sense);
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vsyncerr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vfield_ISR()_E");
   int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_vfield_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv2_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv4_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int2;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int5;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv4_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_wline_ISR()_E");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_s1_wline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vi_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vi_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_lo_vsync_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_lo_vsync_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vline_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vline_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vfield_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_oir_vfield_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv7_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv7_vbuferr_ISR()_X");
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv8_vbuferr_ISR()_E");
    int_clhd_reg  = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int3;
    int_onoff_reg = vdc5_regaddr_system_ctrl[VDC5_CHANNEL_1].syscnt_int6;
    IntState      = *int_onoff_reg;
...
TOPPERS_SYSLOG(LOG_INFO,"VDC5_Ch1_iv8_vbuferr_ISR()_X");

...
*    Interrupt related FIT BSP. Data types.
*
...
/***********************************************************************
* Function: bsp_int_cb_t
*    Type of callback function from interrupt.
*
* Arguments:
*    int_sense - uint32_t
*
...
/***********************************************************************
* Constant: FIT_NO_PTR
*    None as pointer type
************************************************************************/
#define  FIT_NO_PTR  ( (void*) 0 )


/***********************************************************************
* Constant: FIT_NO_FUNC
*    None as function pointer type
************************************************************************/
...
/***********************************************************************
* Type: bsp_int_src_t
*    Type of BSP_INT_SRC_* macro.
************************************************************************/
#define IRQn_Type uint16_t

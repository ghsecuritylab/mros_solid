...
/***********************************************************************
* Structure: r_ospl_debug_watch4_t
*    Watch context
*
* Description:
...
************************************************************************/
#if  R_OSPL_DEBUG_TOOL
void  R_D_Add( int_fast32_t  in_IndexNum,  volatile const void*  in_Address,  uint32_t  in_BreakValue,
               bool_t  in_IsPrintf )
{
...
************************************************************************/
#if R_OSPL_DEBUG_TOOL
bool_t  R_D_Counter( int_fast32_t*  in_out_Counter,  int_fast32_t  in_TargetCount,  char_t*  in_Label )
{
    ...
    counter += 1;
    is_stop = ( counter == in_TargetCount );
    if ( in_Label != NULL )
    {
        r= printf( "%s %d:\n", in_Label, counter );
        R_UNREFERENCED_VARIABLE( r );  /* QAC 3200 : This is not error information */

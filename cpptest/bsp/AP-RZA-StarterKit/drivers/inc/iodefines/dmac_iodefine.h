...
#define DMAC_PA 0xE8200000uL /* DMAC */
#define DMAC    (*(struct st_dmac    *)g_DMACRegs.addr) /* DMAC */
#define DMACRS_PA 0xFCFE1000uL /* DMARS */
#define DMACRS   (*(struct st_dmars    *)g_DMARSRegs.addr)  /* DMARS */
...
#define DMACDMARS0 DMACRS.DMARS0
#define DMACDMARS1 DMACRS.DMARS1
#define DMACDMARS2 DMACRS.DMARS2
#define DMACDMARS3 DMACRS.DMARS3
#define DMACDMARS4 DMACRS.DMARS4
#define DMACDMARS5 DMACRS.DMARS5
#define DMACDMARS6 DMACRS.DMARS6
#define DMACDMARS7 DMACRS.DMARS7
/* <-SEC M1.10.1 */
/* <-QAC 0639 */
#endif

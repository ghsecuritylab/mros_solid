...
#define SDG0_PA    (0xFCFF4800uL) /* SDG0 */
#define SDG1_PA    (0xFCFF4A00uL) /* SDG1 */
#define SDG2_PA    (0xFCFF4C00uL) /* SDG2 */
#define SDG3_PA    (0xFCFF4E00uL) /* SDG3 */
#define SDG0    (*(struct st_sdg     *)g_SDG0Regs.addr) /* SDG0 */
#define SDG1    (*(struct st_sdg     *)g_SDG1Regs.addr) /* SDG1 */
#define SDG2    (*(struct st_sdg     *)g_SDG2Regs.addr) /* SDG2 */
#define SDG3    (*(struct st_sdg     *)g_SDG3Regs.addr) /* SDG3 */

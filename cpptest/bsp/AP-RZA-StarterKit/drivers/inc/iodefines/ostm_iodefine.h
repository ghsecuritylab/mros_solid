...
#define OSTM0_PA 0xFCFEC000uL /* OSTM0 */
#define OSTM1_PA 0xFCFEC400uL /* OSTM1 */
#define OSTM0   (*(struct st_ostm    *)g_OSTM0Regs.addr) /* OSTM0 */
#define OSTM1   (*(struct st_ostm    *)g_OSTM1Regs.addr) /* OSTM1 */

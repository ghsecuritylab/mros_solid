...
#define SCIM0_PA   (0xE800B000uL) /* SCIM0 */
#define SCIM1_PA   (0xE800B800uL) /* SCIM1 */
#define SCIM0   (*(struct st_scim    *)g_SCIM0Regs.addr) /* SCIM0 */
#define SCIM1   (*(struct st_scim    *)g_SCIM1Regs.addr) /* SCIM1 */

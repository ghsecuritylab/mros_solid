...
#define DVDEC1_PA 0xFCFFA008uL /* DVDEC1 */
#define DVDEC0_PA 0xFCFFB808uL /* DVDEC0 */
#define DVDEC1  (*(struct st_dvdec   *)g_DVDEC1Regs.addr) /* DVDEC1 */
#define DVDEC0  (*(struct st_dvdec   *)g_DVDEC0Regs.addr) /* DVDEC0 */

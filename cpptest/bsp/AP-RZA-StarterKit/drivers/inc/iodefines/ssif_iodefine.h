...
#define SSIF0_PA   (0xE820B000uL) /* SSIF0 */
#define SSIF1_PA   (0xE820B800uL) /* SSIF1 */
#define SSIF2_PA   (0xE820C000uL) /* SSIF2 */
#define SSIF3_PA   (0xE820C800uL) /* SSIF3 */
#define SSIF4_PA   (0xE820D000uL) /* SSIF4 */
#define SSIF5_PA   (0xE820D800uL) /* SSIF5 */
#define SSIF0   (*(struct st_ssif    *)g_SSIF0Regs.addr) /* SSIF0 */
#define SSIF1   (*(struct st_ssif    *)g_SSIF1Regs.addr) /* SSIF1 */
#define SSIF2   (*(struct st_ssif    *)g_SSIF2Regs.addr) /* SSIF2 */
#define SSIF3   (*(struct st_ssif    *)g_SSIF3Regs.addr) /* SSIF3 */
#define SSIF4   (*(struct st_ssif    *)g_SSIF4Regs.addr) /* SSIF4 */
#define SSIF5   (*(struct st_ssif    *)g_SSIF5Regs.addr) /* SSIF5 */

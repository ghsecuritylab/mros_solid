...
#define USB200_PA  (0xE8010000uL) /* USB200 */
#define USB201_PA  (0xE8207000uL) /* USB201 */
#define USB200  (*(struct st_usb20   *)g_USB200Regs.addr) /* USB200 */
#define USB201  (*(struct st_usb20   *)g_USB201Regs.addr) /* USB201 */
